...
export default function Home() {
  ...
  return (
    <main className="bg-[#F7F7F7] text-[#717A76] font-sans">
      <Head>
      ...
      {/* NAV */}
      <header className="fixed top-0 left-0 right-0 z-20 bg-white/90 backdrop-blur-md border-b border-[#717A76]/10">
        <nav className="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Image src="/images/logo.png" alt="Alturas Camposanto" width={34} height={34} />
            <span className="font-serif text-[#4A765A] text-lg tracking-wide">Alturas Camposanto</span>
          </div>
          <div className="hidden md:flex gap-6 text-sm">
            <a href="#sobre-nosotros" className="hover:text-[#4A765A] transition">Nosotros</a>
            <a href="#servicios" className="hover:text-[#4A765A] transition">Espacios</a>
            <a href="#contacto" className="hover:text-[#4A765A] transition">Contáctanos</a>
          </div>
        </nav>
      </header>
      ...
      <section className="relative h-[92vh] flex items-center justify-center text-center bg-[url('/images/hero.jpg')] bg-cover bg-center">
        ...
        <div className="relative z-10 px-6">
          ...
          <a href="#contacto" className="inline-block bg-[#4A765A] text-white px-6 py-3 rounded-2xl hover:bg-[#3b5f4c] transition">
            Contáctanos
          </a>
        </div>
      </section>
      ...
      {/* SOBRE NOSOTROS */}
      <section id="sobre-nosotros" className="py-24 px-6 lg:px-8 bg-[#C7D7C1]/30">
        <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="text-3xl font-serif text-[#4A765A] mb-4">Un lugar donde la memoria florece</h2>
            <p className="mb-5 text-[#717A76]">
      ...
      <section id="servicios" className="bg-[#EDEFEA] py-24 px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <h2 className="text-3xl font-serif text-center text-[#4A765A] mb-12">Nuestros espacios</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={s.title} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition">
                ...
                <div className="p-5">
                  <h3 className="font-serif text-lg text-[#4A765A] mb-1">{s.title}</h3>
                  <p className="text-sm text-[#717A76]/90">{s.text}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* CONTACTO */}
      <section id="contacto" className="py-24 px-6 lg:px-8 bg-[#C7D7C1]/25">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="text-3xl font-serif text-[#4A765A] mb-6">Contáctanos</h2>
          <p className="text-[#717A76]/80 mb-8">
          ...
          {!submitted ? (
            ...
            >
              <input type="text" name="nombre" placeholder="Nombre completo" required className="p-3 rounded-lg border border-[#717A76]/20 focus:outline-none focus:ring-2 focus:ring-[#4A765A]" />
              <input type="email" name="email" placeholder="Correo electrónico" required className="p-3 rounded-lg border border-[#717A76]/20 focus:outline-none focus:ring-2 focus:ring-[#4A765A]" />

              <div className="p-3 rounded-lg border border-[#717A76]/20 bg-white">
                <p className="mb-2 font-semibold text-[#4A765A]">Seleccione los productos de su interés:</p>
                {['Nicho Sencillo', 'Nicho Doble', 'Columbario', 'Árbol de Vida'].map((opt) => (
                  <label key={opt} className="flex items-center gap-2 mb-1">
                    <input type="checkbox" name="interes" value={opt} className="accent-[#4A765A]" />
                    {opt}
                  </label>
                ))}
              </div>

              <textarea name="mensaje" rows="4" placeholder="Escribe tu mensaje (opcional)..." className="p-3 rounded-lg border border-[#717A76]/20 focus:outline-none focus:ring-2 focus:ring-[#4A765A]" />

              <button type="submit" className="bg-[#4A765A] text-white py-3 rounded-2xl hover:bg-[#3b5f4c] transition">
                Enviar mensaje
              </button>
            </form>
          ) : (
            <div className="mt-6 p-4 bg-[#C7D7C1]/60 text-[#4A765A] rounded-lg shadow-inner animate-fadeIn">
      ...
      <section className="py-20 px-6 lg:px-8 bg-white">
        <div className="mx-auto max-w-6xl text-center">
          ...
          <p className="text-[#717A76]/80 mb-6">Alturas Camposanto · San Antonio de Desamparados, Costa Rica</p>
          <div className="rounded-2xl overflow-hidden shadow-lg">
            <iframe
              src="https://maps.app.goo.gl/ZfhTCDreDffA8dF67"
              width="100%"
              height="400"
              style={{ border: 0 }}
              allowFullScreen=""
      ...
      {/* FOOTER */}
      <footer className="py-10 px-6 border-t border-[#717A76]/10 bg-white">
        <div className="mx-auto max-w-6xl flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
          <div className="flex items-center gap-3">
            ...
            <span className="font-serif text-[#4A765A]">Alturas Camposanto</span>
          </div>
          <span className="text-xs text-[#717A76]/70">
            © {new Date().getFullYear()} Alturas Camposanto · San Antonio de Desamparados
          </span>
        </div>
      </footer>
